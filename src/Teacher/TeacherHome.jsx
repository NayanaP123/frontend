    ...
    <>
      ...
      <section style={{height:'100vh'}}>
        <div className="container" style={{backgroundColor:'white',borderRadius:'20px'}}>
          ...
          <div>
              <h1 style={{marginTop:'20px',fontFamily:'"Moon Dance", cursive',fontWeight:'500',fontSize:'64px'}} >Hello, <em   style={{fontFamily:'"Cormorant", serif',fontWeight:'500',fontStyle:'italic',fontSize:'74px'}}>Teacher</em> 👋</h1>
              <p style={{color:'blue'}}>Kunnamangalam HSS</p>

             
              <p style={{fontFamily:'"Inconsolata", monospace',fontSize:'20px',marginTop:'10px'}}>Manage classes, mark attendance, and stay updated with schedules and notices. ✏️</p>
